...
export const ExpenseDetailsPage: React.FC<ExpenseDetailsPageProps> = ({ 
  ...
  const uniqueCategories = useMemo(() => {
    ...
    // Combine predefined and transactional, then sort.
      ...
      <div className="max-w-4xl mx-auto">
        <header className="mb-6">
           <div className="block">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-red-400 text-center w-full mt-3">Expense Details</h1>
          </div>
        </header>
        ...
        {expenseTransactions.length === 0 ? (
          ...
          <>
            ...
            {expenseChartData.length === 0 && filteredTransactions.length > 0 && (
              <p className="text-gray-400 text-center mb-6 text-sm">No expense data with categories for the current filter to display chart.</p>
            )}
